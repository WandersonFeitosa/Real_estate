...
<section id="banner-inicial">
    <div id="carousel-banner" class="carousel slide" data-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="allign-box">
                <div class="titulo-banner container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <span>
                                <?php the_field('descricao_carrosel') ?>
                                <span>
                        </div>
                    </div>
                    <div class="row">
                        <a href="<?php the_field('link_botao_carrosel') ?>"><?php the_field('titulo_botao_carrosel') ?></a>
                    </div>
                </div>
            </div>
            ...
            <?php if (have_rows('imagens_fundo_carrossel')) {
             
                while (have_rows('imagens_fundo_carrossel')) {
                    the_row(); ?>


                    <div class="carousel-item active">
                        <img class="d-block " src="<?php the_sub_field('imagem_1') ?>" alt="First slide">
                    </div>
                    <div class="carousel-item">
                        <img class="d-block" src="<?php the_sub_field('imagem_2') ?>" alt="Second slide">
                    </div>
...
<section id="nossa-casa">
    ...
    <div class="caixa-texto">
        <div class="titulo-nossa-casa">
            <h1><?php the_field('titulo_nossa_casa') ?></h1>
        </div>

        <div class="desc-nossa-casa">
            <?php the_field('descricao_nossa_casa') ?>
        </div>
    </div>

    <!-- Galeria de imagens -->
    <div class="expo">
        <?php if (have_rows('imagens_nossa_cara')) {
            while (have_rows('imagens_nossa_cara')) {
                the_row(); ?>
                ...
                <div class="box-expo flexMode">
                    ...
                    <div class="col-expo flexMode">
                        <div class="img-expo">
                            ...
                            <img class="" src="<?php the_sub_field('imagem_1') ?>" alt="">
                        </div>
                    ...
                    <div class="col-expo">
                        <div class="img-expo">
                            <div class="background-expo"></div>
                            <img class="" src="<?php the_sub_field('imagem_2') ?>" alt="">
                        </div>
                        <div class="desc-expo">Distracted</div>
                    </div>
                    ...
                    <div class="col-expo">
                        <div class="img-expo">
                            <div class="background-expo"></div>
                            <img class="" src="<?php the_sub_field('imagem_3') ?>" alt="">
                        </div>
                        <div class="desc-expo">Distracted</div>
                    </div>
                </div>
